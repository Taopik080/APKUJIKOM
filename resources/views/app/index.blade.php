<x-app-layout>
    <div class="container" style="margin-top: 40px; width:100px; position:absolute; margin-left:800px; margin-top:-50px">
                ...
                @foreach ($imgadmin as $image)
                    <div class="col">
                        <div class="card" style="width: 20rem; margin-top:10px">
                            <img src="/img/{{ $image->img }}" style="height: 240px; width:100%; border-radius:8px;"
                                class="card-img-top">
    ...
    <div class="container text-center" style="margin-left: 100px;">
        <div class="row row-cols-auto">
            @foreach ($daerah as $item)
                <div class="col">
                    <a href="{{ route('photos.by.daerah', ['daerah_id' => $item->id]) }}"
                        class="btn btn-outline-secondary">{{ $item->nama_daerah }}</a>
                </div>
            @endforeach
        </div>
    </div>
                        ...
                        <div class="card" style="width: 20rem; margin-top:10px">
                            ...
                            <div class="card-body">
                                ...
                                @if ($photo->user_id == Auth::user()->id)
                                    <div class="dropdown"
                                        style="position: absolute; margin-top:-40px; margin-left:190px;">
                                ...
                                <div class="comment" style="position:absolute; margin-top:20px;">
                                    ...
                                    <a href="{{ route('app.show', $photo->id) }}"
                                        style="color:black; font-size:30px"><ion-icon
                                            name="chatbubble-outline"></ion-icon></a>
                                </div>
                                @if (auth()->check())
                                    @if (!$photo->isLikedBy(auth()->user()))
                                        ...
                                        <form action="{{ route('like', $photo->id) }}" method="POST">
                                            ...
                                            <button type="submit"><ion-icon
                                                    style="font-size: 30px; margin-left:230px; margin-top:-100px;"
