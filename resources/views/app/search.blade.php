                ...
                <div class="row row-cols-auto">
                    <div class="col">
                        <form action="{{ route('search') }}" method="GET" class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Cari berdasarkan nama uploader" aria-label="Search" style="width: 600px; margin-left:95px;" name="q">
                            <button class="btn btn-outline-primary" type="submit">Search</button>
                            <a href="{{ route('app.create') }}" style="margin-left:10px;" class="btn btn-outline-secondary">Submit a photo</a>
                        </form>
                    </div>
                </div>
            </div>
